// Node-side startup registration for mfe-metrics
const http = require("http");

const REGISTRY_URL = process.env.REGISTRY_URL || "http://registry:5000";
const PUBLIC_URL = process.env.PUBLIC_URL || "http://mfe-metrics:80"; // what browsers load
const ID = process.env.MFE_ID || "mfe-metrics";
const NAME = process.env.MFE_NAME || "Metrics";
const PAGE_ROUTE = process.env.MFE_PAGE || "/metrics";
const ORDER = Number(process.env.MFE_ORDER || 20);
